...
- ⚡ **Project Paradox** — Showcased multi-agent LLM framework live at **Supercell HQ in Helsinki** to CEO **Ilkka Paananen**, **Holly Liu** (Kabam), **Kun Gao** (Crunchyroll), **Aaron Loeb** (LEGO), & **Otto Söderlund** (Supercell AI Lead)
